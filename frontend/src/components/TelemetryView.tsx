      ...
      <svg width="100%" height={height} viewBox={`0 0 ${width} ${height}`} style={{ overflow: 'visible' }}>
        ...
        {data.length > 0 && (
          <circle
            ...
            cy={
              height -
              Math.max(0, Math.min(1, (data[data.length - 1] - minVal) / range)) * (height - 8) -
              4
            }
            r="3"
            fill={color}
      ...
      <div className="grid g2">
        ...
        <div className="card">
          ...
          <div style={{ padding: '8px 0' }}>
            {renderSparkline(socHistory, 0, 100, isPaused ? '#C49A4A' : '#FF7A33', 460, 80)}
          </div>
        ...
        <div className="card">
          ...
          <div style={{ padding: '8px 0' }}>
            {renderSparkline(tempHistory, -20, 50, '#5A9B8F', 460, 80)}
          </div>
          <div className="flex-between" style={{ fontSize: '11px', fontFamily: 'var(--font-mono)', color: 'var(--paper-dim)' }}>
            <span>Min: -20°C</span>
