      ...
      <div style={{ marginTop: 'auto', paddingTop: '16px', borderTop: '1px solid var(--border)' }}>
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <span style={{ fontSize: '10px', fontWeight: 600, color: 'var(--paper)' }}>Gemini Diagnostics</span>
            <span style={{ fontSize: '8px', fontFamily: 'var(--font-mono)', color: 'var(--paper-muted)' }}>EXPLAINABLE AI ACTIVE</span>
          </div>
        </div>
      </div>
    </aside>
