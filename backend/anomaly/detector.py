...
class AnomalyDetector:
    ...
    def __init__(
        ...
        self._acknowledged_variables: set[str] = set() # variables currently acknowledged by operator
    ...
    def check_tick(
        ...
        for variable, threshold in self.thresholds.items():
            ...
            if breach:
                # If operator already acknowledged this variable, do not re-fire
                if variable in self._acknowledged_variables:
                    continue
                ...
                # Fire alert after debounce window (within 2 ticks for threshold violations)
                ...
                # Reset breach counter and un-acknowledge on clean recovery
                self._breach_counts[variable] = 0
                self._acknowledged_variables.discard(variable)
    ...
    def acknowledge_alert(
        ...
        self._acknowledged_variables.add(alert.variable)
